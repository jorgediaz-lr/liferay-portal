...
public class JournalFeedPersistenceImpl extends BasePersistenceImpl<JournalFeed>
	...
	protected JournalFeed toUnwrappedModel(JournalFeed journalFeed) {
		...
		journalFeedImpl.setStructureKey(journalFeed.getStructureKey());
		journalFeedImpl.setTemplateKey(journalFeed.getTemplateKey());
		journalFeedImpl.setRendererTemplateKey(journalFeed.getRendererTemplateKey());
	...
	private static final Set<String> _badColumnNames = SetUtil.fromArray(new String[] {
				"uuid", "id", "type", "structureKey", "templateKey",
				"rendererTemplateKey"
			});
