...
public class JournalFeedLocalServiceImpl
	...
	public JournalFeed addFeed(
			...
			String name, String description, String type, String structureKey,
			String templateKey, String rendererTemplateKey, int delta,
		...
		validate(
			user.getCompanyId(), groupId, feedId, autoFeedId, name, structureKey,
		...
		feed.setType(type);
		feed.setStructureKey(structureKey);
		feed.setTemplateKey(templateKey);
		feed.setRendererTemplateKey(rendererTemplateKey);
		feed.setDelta(delta);
	...
	public JournalFeed updateFeed(
			...
			String type, String structureKey, String templateKey,
			String rendererTemplateKey, int delta, String orderByCol,
		...
		validate(
			feed.getCompanyId(), groupId, name, structureKey,
			targetLayoutFriendlyUrl, contentField);
	...
	protected boolean isValidStructureField(
		long groupId, String structureKey, String contentField) {
	...
	protected void validate(
			...
			String name, String structureKey, String targetLayoutFriendlyUrl,
			String contentField)
		throws PortalException {
		...
		validate(
			companyId, groupId, name, structureKey, targetLayoutFriendlyUrl,
			contentField);
	}

	protected void validate(
			long companyId, long groupId, String name, String structureKey,
		...
		if (!isValidStructureField(groupId, structureKey, contentField)) {
