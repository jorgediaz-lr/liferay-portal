...
public abstract class BaseSelectionResourceImpl implements SelectionResource {
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/bulk/v1.0/bulk-selection' -d $'{"documentIds": ___, "selectionScope": ___}' --header 'Content-Type: application/json' -u 'test@example.com:test'
	 */
	@Override
