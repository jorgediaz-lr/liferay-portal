...
public abstract class BaseStatusResourceImpl implements StatusResource {
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/segments-asah/v1.0/experiments/{experimentId}/status' -d $'{"status": ___}' --header 'Content-Type: application/json' -u 'test@example.com:test'
	 */
	@Override
