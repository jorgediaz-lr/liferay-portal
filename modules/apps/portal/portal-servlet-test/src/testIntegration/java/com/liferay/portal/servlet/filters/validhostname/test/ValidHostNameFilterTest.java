...
package com.liferay.portal.servlet.filters.validhostname.test;
...
import com.liferay.portal.servlet.filters.validhostname.ValidHostNameFilter;
...
public class ValidHostNameFilterTest {
	...
	public void testNonexistingVirtualHostWithStrictAccessEnabled()
		...
		try (LogCapture logCapture = LoggerTestUtil.configureLog4JLogger(
				ValidHostNameFilter.class.getName(), LoggerTestUtil.ERROR);
	...
	private void _test(
		...
		try (SafeCloseable safeCloseable =
			...
			_validHostNameFilter.doFilterTry(
	...
	private final ValidHostNameFilter _validHostNameFilter =
		new ValidHostNameFilter();
