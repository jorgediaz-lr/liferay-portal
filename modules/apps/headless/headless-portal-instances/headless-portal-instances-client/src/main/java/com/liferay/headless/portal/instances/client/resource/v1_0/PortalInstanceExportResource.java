...
public interface PortalInstanceExportResource {
	...
	public void postPortalInstanceExportBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postPortalInstanceExportBatchHttpResponse(
	...
	public static class Builder {
		...
		public PortalInstanceExportResource build() {
			return new PortalInstanceExportResourceImpl(this);
		}
	...
	public static class PortalInstanceExportResourceImpl
		implements PortalInstanceExportResource {
		...
		public PortalInstanceExport postPortalInstanceExport(
			...
			HttpInvoker.HttpResponse httpResponse =
				postPortalInstanceExportHttpResponse(portalInstanceExport);
		...
		public HttpInvoker.HttpResponse postPortalInstanceExportHttpResponse(
			...
			httpInvoker.body(
				portalInstanceExport.toString(), "application/json");
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-portal-instances/v1.0/portal-instances/export");
		...
		public void postPortalInstanceExportBatch(
				String callbackURL, Object object)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				postPortalInstanceExportBatchHttpResponse(callbackURL, object);
		...
		private PortalInstanceExportResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PortalInstanceExportResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:1511962117