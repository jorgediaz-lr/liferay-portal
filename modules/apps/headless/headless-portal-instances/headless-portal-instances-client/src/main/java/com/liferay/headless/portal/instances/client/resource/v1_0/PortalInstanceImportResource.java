 ...
 */
@Generated("")
public interface PortalInstanceImportResource {
	...
	public void postPortalInstanceImportBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postPortalInstanceImportBatchHttpResponse(
	...
	public static class Builder {
		...
		public PortalInstanceImportResource build() {
			return new PortalInstanceImportResourceImpl(this);
		}
	...
	public static class PortalInstanceImportResourceImpl
		implements PortalInstanceImportResource {
		...
		public void postPortalInstanceImportBatch(
				String callbackURL, Object object)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				postPortalInstanceImportBatchHttpResponse(callbackURL, object);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-portal-instances/v1.0/portal-instances/import/batch");
		...
		private PortalInstanceImportResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PortalInstanceImportResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:-19138198