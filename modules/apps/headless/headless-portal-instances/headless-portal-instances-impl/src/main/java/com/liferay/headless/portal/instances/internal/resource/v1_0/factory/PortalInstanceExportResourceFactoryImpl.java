 ...
 */
@Component(
	property = "resource.locator.key=/headless-portal-instances/v1.0/PortalInstanceExport",
	service = PortalInstanceExportResource.Factory.class
)
@Generated("")
public class PortalInstanceExportResourceFactoryImpl
	implements PortalInstanceExportResource.Factory {

	@Override
	public PortalInstanceExportResource.Builder create() {
		return new PortalInstanceExportResource.Builder() {
			...
			public PortalInstanceExportResource build() {
				...
				Function<InvocationHandler, PortalInstanceExportResource>
					portalInstanceExportResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_portalInstanceExportResourceProxyProviderFunction;

				return portalInstanceExportResourceProxyProviderFunction.apply(
			...
			@Override
			public PortalInstanceExportResource.Builder checkPermissions(
			...
			@Override
			public PortalInstanceExportResource.Builder httpServletRequest(
			...
			@Override
			public PortalInstanceExportResource.Builder httpServletResponse(
			...
			@Override
			public PortalInstanceExportResource.Builder preferredLocale(
			...
			@Override
			public PortalInstanceExportResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public PortalInstanceExportResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, PortalInstanceExportResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			PortalInstanceExportResource.class.getClassLoader(),
			PortalInstanceExportResource.class);

		try {
			Constructor<PortalInstanceExportResource> constructor =
				(Constructor<PortalInstanceExportResource>)
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, PortalInstanceExportResource>
				_portalInstanceExportResourceProxyProviderFunction =
					_getProxyProviderFunction();
