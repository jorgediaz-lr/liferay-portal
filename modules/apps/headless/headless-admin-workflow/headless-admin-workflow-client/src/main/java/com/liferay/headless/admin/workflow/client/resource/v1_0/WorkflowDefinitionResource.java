...
public interface WorkflowDefinitionResource {
	...
	public HttpInvoker.HttpResponse
			putWorkflowDefinitionByExternalReferenceCodeHttpResponse(
				String externalReferenceCode,
				WorkflowDefinition workflowDefinition)
		throws Exception;
	...
	public static class WorkflowDefinitionResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-workflow/v1.0/workflow-definitions/by-external-reference-code/{externalReferenceCode}");
...
// LIFERAY-REST-BUILDER-HASH:-1143162501