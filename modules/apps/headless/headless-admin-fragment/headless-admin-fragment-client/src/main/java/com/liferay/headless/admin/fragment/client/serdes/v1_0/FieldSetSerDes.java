...
public class FieldSetSerDes {
	...
	public static String toJSON(FieldSet fieldSet) {
		...
		if (fieldSet.getConfigurationRole() != null) {
			...
			sb.append("\"");
			sb.append(fieldSet.getConfigurationRole());
			sb.append("\"");
		}

		if (fieldSet.getCustomComponentModule() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(fieldSet.getCustomComponentModule()));
		...
		if (fieldSet.getLabel() != null) {
			...
			sb.append(_escape(fieldSet.getLabel()));
	...
	public static Map<String, String> toMap(FieldSet fieldSet) {
		...
		if (fieldSet.getConfigurationRole() == null) {
			map.put("configurationRole", null);
		}
		else {
			map.put(
				"configurationRole",
		...
		if (fieldSet.getCustomComponentModule() == null) {
			map.put("customComponentModule", null);
		}
		else {
			map.put(
				"customComponentModule",
				String.valueOf(fieldSet.getCustomComponentModule()));
		}
		...
		if (fieldSet.getLabel() == null) {
			...
			map.put("label", String.valueOf(fieldSet.getLabel()));
		}
	...
	public static class FieldSetJSONParser extends BaseJSONParser<FieldSet> {
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(jsonParserFieldName, "configurationRole")) {
				return false;
			}
			else if (Objects.equals(
						jsonParserFieldName, "customComponentModule")) {
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "configurationRole")) {
				...
				if (jsonParserFieldValue != null) {
					fieldSet.setLabel((String)jsonParserFieldValue);
				}
			}
		}
...
// LIFERAY-REST-BUILDER-HASH:-859182732