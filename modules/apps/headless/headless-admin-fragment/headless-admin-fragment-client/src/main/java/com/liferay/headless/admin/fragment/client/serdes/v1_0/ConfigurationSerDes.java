...
public class ConfigurationSerDes {
	...
	public static String toJSON(Configuration configuration) {
		...
		if (configuration.getFieldSets() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			for (int i = 0; i < configuration.getFieldSets().length; i++) {
				sb.append(String.valueOf(configuration.getFieldSets()[i]));

				if ((i + 1) < configuration.getFieldSets().length) {
					sb.append(", ");
				}
			}
	...
	public static Map<String, String> toMap(Configuration configuration) {
		...
		if (configuration.getFieldSets() == null) {
			...
			map.put("fieldSets", String.valueOf(configuration.getFieldSets()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "fieldSets")) {
				if (jsonParserFieldValue != null) {
					...
					configuration.setFieldSets(fieldSetsArray);
				}
			}
		}
...
// LIFERAY-REST-BUILDER-HASH:-353331253