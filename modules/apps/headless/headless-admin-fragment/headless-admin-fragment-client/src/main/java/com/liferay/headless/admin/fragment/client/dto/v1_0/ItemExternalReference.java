...
public class ItemExternalReference implements Cloneable, Serializable {
	...
	public com.liferay.headless.admin.fragment.client.scope.Scope getScope() {
		return scope;
	}

	public void setScope(
		com.liferay.headless.admin.fragment.client.scope.Scope scope) {
	...
	public void setScope(
		UnsafeSupplier
			<com.liferay.headless.admin.fragment.client.scope.Scope, Exception>
				scopeUnsafeSupplier) {
