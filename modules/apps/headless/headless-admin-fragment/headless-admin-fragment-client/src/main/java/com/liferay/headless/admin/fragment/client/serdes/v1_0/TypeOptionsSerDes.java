...
import com.liferay.headless.admin.fragment.client.dto.v1_0.TypeOptions;
...
public class TypeOptionsSerDes {
	...
	public static String toJSON(TypeOptions typeOptions) {
		...
		if (typeOptions.getDependency() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_toJSON(typeOptions.getDependency()));
		}
	...
	public static Map<String, String> toMap(TypeOptions typeOptions) {
		...
		if (typeOptions.getDependency() == null) {
			...
			map.put("dependency", String.valueOf(typeOptions.getDependency()));
		}
...
// LIFERAY-REST-BUILDER-HASH:252099292