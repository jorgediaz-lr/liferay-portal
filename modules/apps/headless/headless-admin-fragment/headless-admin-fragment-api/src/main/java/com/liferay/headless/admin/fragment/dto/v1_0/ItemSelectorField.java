...
@Generated("")
@GraphQLName(
	description = "An `itemSelector` field of a fragment configuration's field set.",
	value = "ItemSelectorField"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "An `itemSelector` field of a fragment configuration's field set."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ItemSelectorField")
public class ItemSelectorField extends Field implements Serializable {

	public static ItemSelectorField toDTO(String json) {
		return ObjectMapperUtil.readValue(ItemSelectorField.class, json);
	}

	public static ItemSelectorField unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ItemSelectorField.class, json);
	}
	...
	@JsonIgnore
	private Supplier<ItemFragmentConfigurationFieldDefaultValue>
		_defaultValueSupplier;
	...
	@JsonIgnore
	private Supplier<ItemSelectorTypeOptions> _typeOptionsSupplier;
	...
	public String toString() {
		...
		ItemSelectorTypeOptions typeOptions = getTypeOptions();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.fragment.dto.v1_0.ItemSelectorField",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1298855609