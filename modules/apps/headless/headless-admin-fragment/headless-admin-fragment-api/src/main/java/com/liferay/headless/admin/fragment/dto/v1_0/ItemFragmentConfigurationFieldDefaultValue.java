...
@Generated("")
@GraphQLName(
	description = "The default value of an `itemSelector` fragment configuration field. It mirrors the shape of the corresponding fragment configuration field value of the headless admin site API.",
	value = "ItemFragmentConfigurationFieldDefaultValue"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "The default value of an `itemSelector` fragment configuration field. It mirrors the shape of the corresponding fragment configuration field value of the headless admin site API."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ItemFragmentConfigurationFieldDefaultValue")
public class ItemFragmentConfigurationFieldDefaultValue
	...
	public static ItemFragmentConfigurationFieldDefaultValue toDTO(
		...
		return ObjectMapperUtil.readValue(
			ItemFragmentConfigurationFieldDefaultValue.class, json);
	}

	public static ItemFragmentConfigurationFieldDefaultValue unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.fragment.dto.v1_0.ItemFragmentConfigurationFieldDefaultValue",
		name = "x-class-name"
	)
