...
@Generated("")
@GraphQLName(
	description = "The type-specific options of a fragment configuration field.",
	value = "TypeOptions"
)
...
public class TypeOptions implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.fragment.dto.v1_0.TypeOptions",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1200698870