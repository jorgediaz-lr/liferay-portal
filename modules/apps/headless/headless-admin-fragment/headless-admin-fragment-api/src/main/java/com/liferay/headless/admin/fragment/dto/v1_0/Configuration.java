...
@Generated("")
@GraphQLName(
	description = "A fragment's configuration, which defines the field sets a page creator can use to customize the fragment.",
	value = "Configuration"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "A fragment's configuration, which defines the field sets a page creator can use to customize the fragment.",
	requiredProperties = {"fieldSets"}
)
...
public class Configuration implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The configuration's field sets."
	)
	@Valid
	...
	@GraphQLField(description = "The configuration's field sets.")
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.fragment.dto.v1_0.Configuration",
		name = "x-class-name"
	)
