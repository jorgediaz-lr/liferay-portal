 ...
 */
@Component(
	property = "resource.locator.key=/portal-tools-rest-builder-test/v1.0/BatchTestEntityAction",
	service = BatchTestEntityActionResource.Factory.class
)
@Generated("")
public class BatchTestEntityActionResourceFactoryImpl
	implements BatchTestEntityActionResource.Factory {

	@Override
	public BatchTestEntityActionResource.Builder create() {
		return new BatchTestEntityActionResource.Builder() {
			...
			public BatchTestEntityActionResource build() {
				...
				Function<InvocationHandler, BatchTestEntityActionResource>
					batchTestEntityActionResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_batchTestEntityActionResourceProxyProviderFunction;

				return batchTestEntityActionResourceProxyProviderFunction.apply(
			...
			@Override
			public BatchTestEntityActionResource.Builder checkPermissions(
			...
			@Override
			public BatchTestEntityActionResource.Builder httpServletRequest(
			...
			@Override
			public BatchTestEntityActionResource.Builder httpServletResponse(
			...
			@Override
			public BatchTestEntityActionResource.Builder preferredLocale(
			...
			@Override
			public BatchTestEntityActionResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public BatchTestEntityActionResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, BatchTestEntityActionResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			BatchTestEntityActionResource.class.getClassLoader(),
			BatchTestEntityActionResource.class);

		try {
			Constructor<BatchTestEntityActionResource> constructor =
				(Constructor<BatchTestEntityActionResource>)
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, BatchTestEntityActionResource>
				_batchTestEntityActionResourceProxyProviderFunction =
					_getProxyProviderFunction();
