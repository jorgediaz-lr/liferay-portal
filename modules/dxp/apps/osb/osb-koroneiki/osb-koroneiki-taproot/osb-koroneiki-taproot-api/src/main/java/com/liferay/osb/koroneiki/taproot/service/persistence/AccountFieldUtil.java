...
public class AccountFieldUtil {
	...
	private static ServiceTracker
		<AccountFieldPersistence, AccountFieldPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(AccountFieldPersistence.class);

		ServiceTracker<AccountFieldPersistence, AccountFieldPersistence>
			serviceTracker =
				new ServiceTracker
					<AccountFieldPersistence, AccountFieldPersistence>(
						bundle.getBundleContext(),
						AccountFieldPersistence.class, null);
