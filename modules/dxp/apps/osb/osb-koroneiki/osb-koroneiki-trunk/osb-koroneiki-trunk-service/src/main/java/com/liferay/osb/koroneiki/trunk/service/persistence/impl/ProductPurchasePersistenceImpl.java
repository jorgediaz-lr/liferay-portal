...
public class ProductPurchasePersistenceImpl
	...
	public void activate() {
		...
		_setProductPurchaseUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setProductPurchaseUtilPersistence(null);
	...
	private void _setProductPurchaseUtilPersistence(
		ProductPurchasePersistence productPurchasePersistence) {

		try {
			Field field = ProductPurchaseUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, productPurchasePersistence);
		}
