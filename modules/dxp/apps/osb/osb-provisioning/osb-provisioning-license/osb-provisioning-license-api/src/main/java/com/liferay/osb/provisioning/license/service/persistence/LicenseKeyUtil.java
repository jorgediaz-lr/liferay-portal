...
public class LicenseKeyUtil {
	...
	public static List<LicenseKey> findByU_AK(
		...
		return getPersistence().findByU_AK(userUuid, accountKey);
	}
	...
	public static List<LicenseKey> findByU_AK(
		...
		return getPersistence().findByU_AK(userUuid, accountKey, start, end);
	}
	...
	public static LicenseKey[] findByU_AK_PrevAndNext(
		...
		return getPersistence().findByU_AK_PrevAndNext(
			licenseKeyId, userUuid, accountKey, orderByComparator);
	}
	 ...
	 * @param accountKey the account key
	 */
	public static void removeByU_AK(String userUuid, String accountKey) {
		getPersistence().removeByU_AK(userUuid, accountKey);
	}
	 ...
	 * @return the number of matching license keies
	 */
	public static int countByU_AK(String userUuid, String accountKey) {
		return getPersistence().countByU_AK(userUuid, accountKey);
	}
	...
	public static List<LicenseKey> findByU_PI(
		...
		return getPersistence().findByU_PI(userUuid, productId);
	}
	...
	public static List<LicenseKey> findByU_PI(
		...
		return getPersistence().findByU_PI(userUuid, productId, start, end);
	}
	...
	public static List<LicenseKey> findByU_PI(
		...
		return getPersistence().findByU_PI(
			userUuid, productId, start, end, orderByComparator, useFinderCache);
	}
	...
	public static LicenseKey[] findByU_PI_PrevAndNext(
		...
		return getPersistence().findByU_PI_PrevAndNext(
			licenseKeyId, userUuid, productId, orderByComparator);
	}
	 ...
	 * @param productId the product ID
	 */
	public static void removeByU_PI(String userUuid, String productId) {
		getPersistence().removeByU_PI(userUuid, productId);
	}
	 ...
	 * @return the number of matching license keies
	 */
	public static int countByU_PI(String userUuid, String productId) {
		return getPersistence().countByU_PI(userUuid, productId);
	}
