...
public class LicenseEntryPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByPK_V;
	private FinderPath _finderPathWithPaginationCountByPK_V;

	/**
	 * Returns all the license entries where productKey = &#63; and versionMin &le; &#63;.
	 *
	 * @param productKey the product key
	 ...
	 */
	@Override
	public List<LicenseEntry> findByPK_V(String productKey, int versionMin) {
		return findByPK_V(
			productKey, versionMin, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the license entries where productKey = &#63; and versionMin &le; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LicenseEntryModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<LicenseEntry> findByPK_V(
		String productKey, int versionMin, int start, int end) {

		return findByPK_V(productKey, versionMin, start, end, null);
	}

	/**
	 * Returns an ordered range of all the license entries where productKey = &#63; and versionMin &le; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LicenseEntryModelImpl</code>.
	 * </p>
	...
	public List<LicenseEntry> findByPK_V(
		...
		return findByPK_V(
			productKey, versionMin, start, end, orderByComparator, true);
	}
	...
	public List<LicenseEntry> findByPK_V(
		...
		finderPath = _finderPathWithPaginationFindByPK_V;
		finderArgs = new Object[] {
			productKey, versionMin, start, end, orderByComparator
		};
		...
		if (list == null) {
			...
			if (productKey.isEmpty()) {
				sb.append(_FINDER_COLUMN_PK_V_PRODUCTKEY_3);
			}
			else {
				bindProductKey = true;

				sb.append(_FINDER_COLUMN_PK_V_PRODUCTKEY_2);
			}

			sb.append(_FINDER_COLUMN_PK_V_VERSIONMIN_2);
	...
	/**
	 * Returns the first license entry in the ordered set where productKey = &#63; and versionMin &le; &#63;.
	 *
	 * @param productKey the product key
	 * @param versionMin the version min
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public LicenseEntry findByPK_V_First(
			String productKey, int versionMin,
			OrderByComparator<LicenseEntry> orderByComparator)
		throws NoSuchLicenseEntryException {

		LicenseEntry licenseEntry = fetchByPK_V_First(
			productKey, versionMin, orderByComparator);
	 ...
	 */
	@Override
	public LicenseEntry fetchByPK_V_First(
		String productKey, int versionMin,
		OrderByComparator<LicenseEntry> orderByComparator) {

		List<LicenseEntry> list = findByPK_V(
			productKey, versionMin, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last license entry in the ordered set where productKey = &#63; and versionMin &le; &#63;.
	 *
	 * @param productKey the product key
	 * @param versionMin the version min
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public LicenseEntry findByPK_V_Last(
			String productKey, int versionMin,
			OrderByComparator<LicenseEntry> orderByComparator)
		throws NoSuchLicenseEntryException {

		LicenseEntry licenseEntry = fetchByPK_V_Last(
			productKey, versionMin, orderByComparator);
	 ...
	 */
	@Override
	public LicenseEntry fetchByPK_V_Last(
		String productKey, int versionMin,
		OrderByComparator<LicenseEntry> orderByComparator) {

		int count = countByPK_V(productKey, versionMin);
		...
		List<LicenseEntry> list = findByPK_V(
			productKey, versionMin, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the license entries before and after the current license entry in the ordered set where productKey = &#63; and versionMin &le; &#63;.
	 *
	 * @param licenseEntryId the primary key of the current license entry
	 * @param productKey the product key
	 * @param versionMin the version min
	 ...
	 */
	@Override
	public LicenseEntry[] findByPK_V_PrevAndNext(
			long licenseEntryId, String productKey, int versionMin,
			OrderByComparator<LicenseEntry> orderByComparator)
		throws NoSuchLicenseEntryException {
		...
		try {
			...
			array[0] = getByPK_V_PrevAndNext(
				session, licenseEntry, productKey, versionMin,
				orderByComparator, true);

			array[1] = licenseEntry;

			array[2] = getByPK_V_PrevAndNext(
				session, licenseEntry, productKey, versionMin,
	...
	protected LicenseEntry getByPK_V_PrevAndNext(
		Session session, LicenseEntry licenseEntry, String productKey,
	...
	/**
	 * Removes all the license entries where productKey = &#63; and versionMin &le; &#63; from the database.
	 *
	 * @param productKey the product key
	 * @param versionMin the version min
	 */
	@Override
	public void removeByPK_V(String productKey, int versionMin) {
		for (LicenseEntry licenseEntry :
				findByPK_V(
					productKey, versionMin, QueryUtil.ALL_POS,
	...
	/**
	 * Returns the number of license entries where productKey = &#63; and versionMin &le; &#63;.
	 *
	 * @param productKey the product key
	 * @param versionMin the version min
	 * @return the number of matching license entries
	 */
	@Override
	public int countByPK_V(String productKey, int versionMin) {
		productKey = Objects.toString(productKey, "");

		FinderPath finderPath = _finderPathWithPaginationCountByPK_V;

		Object[] finderArgs = new Object[] {productKey, versionMin};
	...
	private static final String _FINDER_COLUMN_PK_V_PRODUCTKEY_2 =
		"licenseEntry.productKey = ? AND ";

	private static final String _FINDER_COLUMN_PK_V_PRODUCTKEY_3 =
		"(licenseEntry.productKey IS NULL OR licenseEntry.productKey = '') AND ";

	private static final String _FINDER_COLUMN_PK_V_VERSIONMIN_2 =
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByPK_V = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, LicenseEntryImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByPK_V",
			new String[] {
				String.class.getName(), Integer.class.getName(),
		...
		_finderPathWithPaginationCountByPK_V = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByPK_V",
