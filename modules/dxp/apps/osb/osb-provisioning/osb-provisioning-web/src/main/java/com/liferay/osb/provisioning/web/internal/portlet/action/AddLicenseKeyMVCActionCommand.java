...
public class AddLicenseKeyMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		try {
			...
			String accountCode = ParamUtil.getString(
				actionRequest, "accountCode");
			String accountName = ParamUtil.getString(
				actionRequest, "accountName");
			...
			_licenseKeyService.addLicenseKey(
				themeDisplay.getUserId(), licenseEntryId, productKey,
				accountKey, productPurchaseKey, accountCode, accountName,
				productVersion, 0, owner, maxServers, maxHttpSessions, 0, 0,
				sizing, description, hostNames.toArray(new String[0]),
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLicenseKeyMVCActionCommand.class);
