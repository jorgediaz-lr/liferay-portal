...
package com.liferay.headless.osb.commerce.client.resource.v1_0;

import com.liferay.headless.osb.commerce.client.dto.v1_0.UserAccount;
import com.liferay.headless.osb.commerce.client.http.HttpInvoker;
import com.liferay.headless.osb.commerce.client.problem.Problem;
...
public interface UserAccountResource {
	...
	public static class UserAccountResourceImpl implements UserAccountResource {
		...
		public UserAccount postUserAccount(
			...
			try {
				return com.liferay.headless.osb.commerce.client.serdes.v1_0.
					UserAccountSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
