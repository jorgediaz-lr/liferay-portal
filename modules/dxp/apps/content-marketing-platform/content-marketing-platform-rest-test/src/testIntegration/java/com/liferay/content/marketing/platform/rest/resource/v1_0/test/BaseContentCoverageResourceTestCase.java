...
import com.liferay.content.marketing.platform.rest.client.dto.v1_0.ContentCoverage;
...
import com.liferay.content.marketing.platform.rest.client.resource.v1_0.ContentCoverageResource;
import com.liferay.content.marketing.platform.rest.client.serdes.v1_0.ContentCoverageSerDes;
...
public abstract class BaseContentCoverageResourceTestCase {
	...
	protected void assertValid(ContentCoverage contentCoverage)
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("assetCount", additionalAssertFieldName)) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("assetCount", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						contentCoverage1.getAssetCount(),
						contentCoverage2.getAssetCount())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("assetCount")) {
			throw new IllegalArgumentException(
	...
	protected ContentCoverage randomContentCoverage() throws Exception {
		return new ContentCoverage() {
			{
				assetCount = RandomTestUtil.randomLong();
			}
		};
	}
	...
	private com.liferay.content.marketing.platform.rest.resource.v1_0.
		ContentCoverageResource _contentCoverageResource;

}
// LIFERAY-REST-BUILDER-HASH:1541630807