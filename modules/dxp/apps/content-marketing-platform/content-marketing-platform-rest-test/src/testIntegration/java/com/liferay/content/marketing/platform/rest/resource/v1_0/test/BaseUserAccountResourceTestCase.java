...
import com.liferay.content.marketing.platform.rest.client.dto.v1_0.UserAccount;
...
import com.liferay.content.marketing.platform.rest.client.resource.v1_0.UserAccountResource;
import com.liferay.content.marketing.platform.rest.client.serdes.v1_0.UserAccountSerDes;
...
public abstract class BaseUserAccountResourceTestCase {
	...
	public void testGetProjectUserAccountsPage() throws Exception {
		Long projectId = testGetProjectUserAccountsPage_getProjectId();
		Long irrelevantProjectId =
			testGetProjectUserAccountsPage_getIrrelevantProjectId();
		...
		if (irrelevantProjectId != null) {
			UserAccount irrelevantUserAccount =
				testGetProjectUserAccountsPage_addUserAccount(
			...
			assertValid(
				page,
				testGetProjectUserAccountsPage_getExpectedActions(
					irrelevantProjectId));
		}
		...
		assertValid(
			page, testGetProjectUserAccountsPage_getExpectedActions(projectId));
	}

	protected Map<String, Map<String, String>>
			testGetProjectUserAccountsPage_getExpectedActions(Long projectId)
		throws Exception {
	...
	@Test
	public void testGetProjectUserAccountsPageWithPagination()
		throws Exception {
	...
	protected Long testGetProjectUserAccountsPage_getIrrelevantProjectId()
		throws Exception {
	...
	@Inject
	private com.liferay.content.marketing.platform.rest.resource.v1_0.
		UserAccountResource _userAccountResource;

}
// LIFERAY-REST-BUILDER-HASH:1860978331