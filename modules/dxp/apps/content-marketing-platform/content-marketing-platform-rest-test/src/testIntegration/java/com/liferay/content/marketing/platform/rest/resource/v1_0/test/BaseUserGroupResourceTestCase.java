...
package com.liferay.content.marketing.platform.rest.resource.v1_0.test;
...
import com.liferay.content.marketing.platform.rest.client.dto.v1_0.UserGroup;
import com.liferay.content.marketing.platform.rest.client.http.HttpInvoker;
import com.liferay.content.marketing.platform.rest.client.pagination.Page;
import com.liferay.content.marketing.platform.rest.client.pagination.Pagination;
import com.liferay.content.marketing.platform.rest.client.resource.v1_0.UserGroupResource;
import com.liferay.content.marketing.platform.rest.client.serdes.v1_0.UserGroupSerDes;
...
public abstract class BaseUserGroupResourceTestCase {
	...
	public void testGetProjectUserGroupsPage() throws Exception {
		Long projectId = testGetProjectUserGroupsPage_getProjectId();
		Long irrelevantProjectId =
			testGetProjectUserGroupsPage_getIrrelevantProjectId();
		...
		if (irrelevantProjectId != null) {
			UserGroup irrelevantUserGroup =
				testGetProjectUserGroupsPage_addUserGroup(
					irrelevantProjectId, randomIrrelevantUserGroup());
			...
			assertValid(
				page,
				testGetProjectUserGroupsPage_getExpectedActions(
					irrelevantProjectId));
		}

		UserGroup userGroup1 = testGetProjectUserGroupsPage_addUserGroup(
			projectId, randomUserGroup());

		UserGroup userGroup2 = testGetProjectUserGroupsPage_addUserGroup(
			projectId, randomUserGroup());

		page = userGroupResource.getProjectUserGroupsPage(
			projectId, null, Pagination.of(1, (int)totalCount + 2));
		...
		assertValid(
			page, testGetProjectUserGroupsPage_getExpectedActions(projectId));
	}

	protected Map<String, Map<String, String>>
			testGetProjectUserGroupsPage_getExpectedActions(Long projectId)
		throws Exception {
	...
	@Test
	public void testGetProjectUserGroupsPageWithPagination() throws Exception {
		Long projectId = testGetProjectUserGroupsPage_getProjectId();

		Page<UserGroup> userGroupsPage =
			userGroupResource.getProjectUserGroupsPage(projectId, null, null);
		...
		UserGroup userGroup3 = testGetProjectUserGroupsPage_addUserGroup(
			projectId, randomUserGroup());
		...
		if (totalCount >= (pageSizeLimit - 2)) {
			Page<UserGroup> page1 = userGroupResource.getProjectUserGroupsPage(
				projectId, null,
				Pagination.of(
			...
			Page<UserGroup> page2 = userGroupResource.getProjectUserGroupsPage(
				projectId, null,
				Pagination.of(
			...
			Page<UserGroup> page3 = userGroupResource.getProjectUserGroupsPage(
				projectId, null,
				Pagination.of(
	...
	protected Long testGetProjectUserGroupsPage_getIrrelevantProjectId()
		throws Exception {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.content.marketing.platform.rest.dto.v1_0.
						UserGroup.class)) {
		...
		return new UserGroup() {
			{
				...
				usersCount = RandomTestUtil.randomLong();
			}
		};
	}
	...
	@Inject
	private
		com.liferay.content.marketing.platform.rest.resource.v1_0.
			UserGroupResource _userGroupResource;

}
// LIFERAY-REST-BUILDER-HASH:-117444036