...
package com.liferay.content.marketing.platform.web.internal.model.listener.test;
...
public class ObjectEntryAuditModelListenerTest {
	...
	public void testOnAfterCreate() throws Exception {
		...
		CMPTestUtil.addCMPTaskLinkObjectEntry(
			_cmpTaskObjectEntry,
			CMPTestUtil.addCMSBasicWebContentObjectEntry(_depotEntry, title));
	...
	@Inject(
		filter = "component.name=com.liferay.content.marketing.platform.web.internal.model.listener.ObjectEntryModelListener"
	)
