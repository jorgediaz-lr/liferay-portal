...
public class TaskSectionTableFDSViewTest
	...
	public void testGetFDSTableSchema() throws Exception {
		_testGetFDSTableSchema(
			"com.liferay.content.marketing.platform.web-all-tasks");
		_testGetFDSTableSchema(
			"com.liferay.content.marketing.platform.web-project-tasks");
	}

	@Override
	protected String getFDSName() {
		return "com.liferay.content.marketing.platform.web-project-tasks";
	}
