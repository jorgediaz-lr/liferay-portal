...
package com.liferay.content.marketing.platform.web.internal.model.listener;

import com.liferay.content.marketing.platform.web.internal.util.CMPObjectEntryUtil;
import com.liferay.content.marketing.platform.web.internal.util.CMPProjectObjectEntryValuesUtil;
import com.liferay.content.marketing.platform.web.internal.util.RoleUtil;
import com.liferay.content.marketing.platform.web.internal.util.SiteInitializerUtil;
...
public class ObjectEntryModelListener extends BaseModelListener<ObjectEntry> {
	...
	@Reference(
		target = "(site.initializer.key=com.liferay.content.marketing.platform.site.initializer)"
	)
